 ...
 */
public class ForwardStrainChromosomeSnpPositionInputStream implements
        SnpPositionInputStream
{
     ...
     */
    public ForwardStrainChromosomeSnpPositionInputStream(
    ...
    {
        return this.index < this.snps.length;
    }
